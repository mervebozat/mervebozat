%Ödevimde adam-saat verilerinin verimlerini hesaplattým.
%Öncelikle miktar deðerlerini doldurduk örneðin toplam miktarlar:kalýp 5200,demir 300,beton 1500 kullandým.
%Ardýndan adam-saat verilerini girdik. Yönetmeliðe göre adam-saat kalýp imalatý 2.055, demir 48.771,  beton 2.834
%Bu deðerleri girdikten sonra hepsine tek tek hesapla diyerek toplam
%saat,toplam gün, 10 iþçi ile gün deðerleri hesaplanarak proje süresi
%bulundu.
%Diðer aþamada örneðin 200.gün girildi.hesapla ile normalde planlanan %
%hesaplandý. 200.günde gerçekleþen kalýp,demir,beton miktarlarý yine elle yazýldý.
%Örneðin kalýp 3000,demir 120, beton 800 belirledim.Adam saatler yine ayný þekilde yönetmeliðe göre kalýp imalatý 2.055, demir 48.771,  beton 2.834
%olacak þekilde yazýldý.
%Hesaplatýlarak 200.gün toplam saat ve gerçekleþen % hesaplandý.
% Son aþamada yine 200.günde hesapla butonu ile istenen bulundu.Fakat bu
% aþamada gerçekleþen deðil planlanan 200.gün verilerini hesapladýk. Verim
% bularken kullanacaðýz
%Planlanan miktarlar hesaplatýldý. Adam saat deðerlerimiz yine
%yönetmelikten kalýp imalatý 2.055, demir 48.771,  beton 2.834 yazýldý.
%Ardýndan yine hesapla butonlarý ile toplam saat planlanan ve verim elde
%edildi.



function varargout = untitled712022(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @untitled712022_OpeningFcn, ...
                   'gui_OutputFcn',  @untitled712022_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before untitled712022 is made visible.
function untitled712022_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = untitled712022_OutputFcn(hObject, eventdata, handles) 

varargout{1} = handles.output;



function kalipmiktar_Callback(hObject, eventdata, handles)


% --- Executes during object creation, after setting all properties.
function kalipmiktar_CreateFcn(hObject, eventdata, handles)
...
function demirmiktari_Callback(hObject, eventdata, handles)



% --- Executes during object creation, after setting all properties.
function demirmiktari_CreateFcn(hObject, eventdata, handles)
...
function betondokummiktar_Callback(hObject, eventdata, handles)

function betondokummiktar_CreateFcn(hObject, eventdata, handles)
...
% --- Executes on button press in pushbuttonkalip.
function pushbuttonkalip_Callback(hObject, eventdata, handles)

sayi1=str2double(get(handles.kalipmiktar,'String'));
sayi2=str2double(get(handles.edit4,'String'));
carp=sayi1*sayi2;
set(handles.edit7,'String',carp);




% --- Executes during object creation, after setting all properties.
function pushbuttonkalip_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbuttonkalip (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes on button press in pushbuttonbeton.
function pushbuttonbeton_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.betondokummiktar,'String'));
sayi2=str2double(get(handles.edit6,'String'));
carp=sayi1*sayi2;
set(handles.edit9,'String',carp);

% --- Executes during object creation, after setting all properties.
function pushbuttonbeton_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbuttonbeton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes on button press in pushbuttondemir.
function pushbuttondemir_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.demirmiktari,'String'));
sayi2=str2double(get(handles.edit5,'String'));
carp=sayi1*sayi2;
set(handles.edit8,'String',carp);

% --- Executes during object creation, after setting all properties.
function pushbuttondemir_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbuttondemir (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
sayi1=str2double(get(handles.edit71,'String'));
sayi2=str2double(get(handles.edit74,'String'));
carp=sayi1*sayi2;
set(handles.edit77,'String',carp);


% --- Executes on button press in pushbutton12.
function pushbutton12_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit73,'String'));
sayi2=str2double(get(handles.edit76,'String'));
carp=sayi1*sayi2;
set(handles.edit79,'String',carp);


% --- Executes on button press in pushbutton13.
function pushbutton13_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit72,'String'));
sayi2=str2double(get(handles.edit75,'String'));
carp=sayi1*sayi2;
set(handles.edit78,'String',carp);
...
sayi1=str2double(get(handles.edit7,'String'));
sayi2=str2double(get(handles.edit8,'String'));
sayi3=str2double(get(handles.edit9,'String'));
topla=sayi1+sayi2+sayi3;
set(handles.edit82,'String',topla);
...
sayi1=str2double(get(handles.edit7,'String'));
sayi2=8
sayi3=str2double(get(handles.edit13,'String'));
bol=sayi1/sayi2;
set(handles.edit13,'String',bol);

% --- Executes on button press in pushbutton19.
function pushbutton19_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit8,'String'));
sayi2=8
sayi3=str2double(get(handles.edit14,'String'));
bol=sayi1/sayi2;
set(handles.edit14,'String',bol);

% --- Executes on button press in pushbutton20.
function pushbutton20_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit9,'String'));
sayi2=8
sayi3=str2double(get(handles.edit15,'String'));
bol=sayi1/sayi2;
set(handles.edit15,'String',bol);


% --- Executes on button press in pushbutton21.
function pushbutton21_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit13,'String'));
sayi2=str2double(get(handles.edit14,'String'));
sayi3=str2double(get(handles.edit15,'String'));
topla=sayi1+sayi2+sayi3;
set(handles.edit83,'String',topla);
...
sayi1=str2double(get(handles.edit13,'String'));
sayi2=10
sayi3=str2double(get(handles.edit85,'String'));
bol=sayi1/sayi2;
set(handles.edit85,'String',bol);

% --- Executes on button press in pushbutton23.
function pushbutton23_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit14,'String'));
sayi2=10
sayi3=str2double(get(handles.edit86,'String'));
bol=sayi1/sayi2;
set(handles.edit86,'String',bol);

function pushbutton24_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit15,'String'));
sayi2=10
sayi3=str2double(get(handles.edit87,'String'));
bol=sayi1/sayi2;
set(handles.edit87,'String',bol);

function pushbutton25_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit85,'String'));
sayi2=str2double(get(handles.edit86,'String'));
sayi3=str2double(get(handles.edit87,'String'));
topla=sayi1+sayi2+sayi3;
set(handles.edit88,'String',topla);
...
sayi3=str2double(get(handles.edit87,'String'));
topla=sayi1+sayi2+sayi3;
set(handles.edit16,'String',topla);
...
sayi1=str2double(get(handles.edit77,'String'));
sayi2=str2double(get(handles.edit78,'String'));
sayi3=str2double(get(handles.edit79,'String'));
topla=sayi1+sayi2+sayi3;
set(handles.edit94,'String',topla);


% --- Executes on button press in pushbutton29.
function pushbutton29_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit94,'String'));
sayi2=100;
sayi3=str2double(get(handles.edit82,'String'));
bol=(sayi1*sayi2)/sayi3;
set(handles.edit95,'String',bol);
...
sayi1=str2double(get(handles.text92,'String'));
sayi2=str2double(get(handles.edit88,'String'));
bol=sayi1/sayi2;
set(handles.edit90,'String',bol);
...
sayi1=str2double(get(handles.edit97,'String'));
sayi2=str2double(get(handles.edit88,'String'));
bol=sayi1/sayi2;
set(handles.text94,'String',bol);


% --- Executes on button press in pushbutton32.
function pushbutton32_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.text94,'String'));
sayi2=str2double(get(handles.kalipmiktar,'String'));
carp=sayi1*sayi2;
set(handles.edit55,'String',carp);
...
sayi1=str2double(get(handles.text94,'String'));
sayi2=str2double(get(handles.demirmiktari,'String'));
carp=sayi1*sayi2;
set(handles.edit56,'String',carp);

% --- Executes on button press in pushbutton36.
function pushbutton36_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.text94,'String'));
sayi2=str2double(get(handles.betondokummiktar,'String'));
carp=sayi1*sayi2;
set(handles.edit57,'String',carp);


% --- Executes on button press in pushbutton38.
function pushbutton38_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit56,'String'));
sayi2=str2double(get(handles.edit59,'String'));
carp=sayi1*sayi2;
set(handles.edit65,'String',carp);

% --- Executes on button press in pushbutton39.
function pushbutton39_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit57,'String'));
sayi2=str2double(get(handles.edit60,'String'));
carp=sayi1*sayi2;
set(handles.edit66,'String',carp);

function pushbutton40_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit55,'String'));
sayi2=str2double(get(handles.edit58,'String'));
carp=sayi1*sayi2;
set(handles.edit64,'String',carp);
...
sayi1=str2double(get(handles.edit65,'String'));
sayi2=str2double(get(handles.edit78,'String'));
bol=sayi1/sayi2;
set(handles.edit103,'String',bol);

function pushbutton42_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit66,'String'));
sayi2=str2double(get(handles.edit79,'String'));
bol=sayi1/sayi2;
set(handles.edit102,'String',bol);


function pushbutton43_Callback(hObject, eventdata, handles)
sayi1=str2double(get(handles.edit64,'String'));
sayi2=str2double(get(handles.edit77,'String'));
bol=sayi1/sayi2;
set(handles.edit98,'String',bol);
