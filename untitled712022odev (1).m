...
% --- Executes on button press in verigrafigi.
function verigrafigi_Callback(hObject, eventdata, handles)
axes(handles.grafikcizdir);
x=linspace(5,20,100);
y=x.^2
plot(x,y)
...
% --- Executes during object creation, after setting all properties.
function grafikcizdir_CreateFcn(hObject, eventdata, handles)
